...
- Added an `--h5` option to `fragtk matrix` to directly output the results as a 10x Genomics-compatible HDF5 file natively. Note: This requires compiling with `cargo build --release --features hdf5`.
